...
import com.etech.starranking.ui.activity.ui.login.LoginPresenter;
import com.etech.starranking.utils.AppUtils;

import java.text.DecimalFormat;
import java.text.NumberFormat;

public class EmailOtpVerificationActivity extends BaseActivity implements
        EmailOtpVerificationContract.View {
    public ActivityEmailVerificationBinding binding;
    EmailOtpVerificationContract.Presenter<EmailOtpVerificationContract.View> presenter;
    String intentString="";
    String email="";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new EmailOtpVerificationPresenter<>();
    ...
    public void onSuccessEmailVerification(LoginProfile model) {
        ...
        Intent i = new Intent(EmailOtpVerificationActivity.this, LoginActivity.class);
        startActivity(i);
        //finish();
    }
    ...
    @Override
    public void onFailOtpResend(String message) {
